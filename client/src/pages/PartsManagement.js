                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-white">Parts Inventory Management</h1>
                                <p className="text-dark-300 mt-1">Manage stock levels and monitor inventory status</p>
                            </div>
                        </div>
                    </div>
